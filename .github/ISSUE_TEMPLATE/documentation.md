...
about: Suggest an update or improvement to the gnome-extensions repository
...
<!-- What part of the documentation needs improvement? (e.g., README, CONTRIBUTING, translations, code comments, etc.) -->
...
- [ ] I have read and agree to the [Code of Conduct](https://github.com/padparadscho/gnome-extensions/blob/main/CODE_OF_CONDUCT.md).
